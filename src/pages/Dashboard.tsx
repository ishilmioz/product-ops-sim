export default function Dashboard() {
  const metrics = [
    ...
    { label: "Team Velocity", value: "34 pts", color: "bg-emerald-500" },
    { label: "Scope Stability", value: "81%", color: "bg-amber-500" },
  ];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {metrics.map((m) => (
          <div
            key={m.label}
            className="p-6 rounded-xl shadow bg-white flex flex-col gap-3 border border-slate-100"
          >
