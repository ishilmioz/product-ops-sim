...
export default function Decisions() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6 text-slate-900">Decisions</h1>

      <div className="space-y-6">

        <div className="p-4 bg-white shadow rounded-xl border">
          <h2 className="font-semibold mb-2 text-slate-900">Hire 1 more engineer?</h2>
          <div className="flex gap-4">
            <button
  className={`px-4 py-2 rounded text-sm font-medium ${
    decisions.hireEngineer === "Yes"
...
>
  No
        ...
        <div className="p-4 bg-white shadow rounded-xl border">
          <h2 className="font-semibold mb-2 text-slate-900">QA Automation Budget</h2>
          <input
            type="range"
            min={0}
            max={100}
